...
dependencies {
    ...
    implementation 'de.bsommerfeld.jshepherd:json:4.1.1'
    implementation 'de.bsommerfeld.jshepherd:toml:4.1.1'
    implementation 'de.bsommerfeld.jshepherd:properties:4.1.1'
}
```
