...
dependencies {
    ...
    implementation 'de.bsommerfeld.jshepherd:json:4.2.0'
    implementation 'de.bsommerfeld.jshepherd:toml:4.2.0'
    implementation 'de.bsommerfeld.jshepherd:properties:4.2.0'
}
```
